...
fn main() {
    ...
    loop {
        ...
        println!("{} gobbles up the {}", hatch_pet.pet_name, combo.speak);
        println!(
        ...
        attribute_changer(&mut hatch_pet, &combo);
        println!("{} finsihed their {}", hatch_pet.pet_name, combo.speak);
        println!(
        ...
        attribute_changer(&mut hatch_pet, &combo);
        println!("{} settles down to {}", hatch_pet.pet_name, combo.speak);
        println!(
...
fn attribute_changer(hatch_pet: &mut Pet, combo: &Event) {
    match combo.attchange1 {
        1 => hatch_pet.intense = hatch_pet.intense + 5,
        2 => hatch_pet.intense = hatch_pet.intense - 5,
        3 => hatch_pet.heat = hatch_pet.heat + 5,
        4 => hatch_pet.heat = hatch_pet.heat - 5,
        5 => hatch_pet.noise = hatch_pet.noise + 5,
        6 => hatch_pet.noise = hatch_pet.noise - 5,
        7 => hatch_pet.sweet = hatch_pet.sweet + 5,
        8 => hatch_pet.sweet = hatch_pet.sweet - 5,
        9 => hatch_pet.pretty = hatch_pet.pretty + 5,
        10 => hatch_pet.pretty = hatch_pet.pretty - 5,
        11 => hatch_pet.damp = hatch_pet.damp + 5,
        12 => hatch_pet.damp = hatch_pet.damp - 5,
        13 => hatch_pet.colour = hatch_pet.colour + 5,
        14 => hatch_pet.colour = hatch_pet.colour - 5,
        _ => println!("Error"),
    };
